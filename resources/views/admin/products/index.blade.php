        ...
        <table class="min-w-full border border-gray-300 rounded">
            <thead>
                <tr class="bg-gray-200 text-left">
                    ...
                    <th class="py-2 px-4 border-b">Checked by</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-2 px-4">{{ $product->discount_percent }}%</td>
                    <td class="py-2 px-4">{{ $product->final_price }}</td>
                    <td class="py-2 px-4 capitalize">{{ $product->status }}</td>
                    <td class="py-2 px-4">{{ $product->created_at->format('Y-m-d') }}</td>
                    <td class="py-2 px-4">{{ $product->created_by }}</td>
                    <td class="py-2 px-4">
                        {{ $product->checked_by ?? 'Added by seeder' }}
                    </td>
                    <td class="border p-2">
